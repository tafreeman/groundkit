...
| [ADR-0027](ADR-0027-the-rebuild-cliff-reading-selects-persisted-postings.md) | The rebuild-cliff reading selects persisted postings, and retires GK-020's incremental rebuild | Proposed |
